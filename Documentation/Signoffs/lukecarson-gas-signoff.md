...
So the change of 1 ppm results in a change of 0.33mV, the noise level of 110uV is indeed significantly smaller than the voltage change associated with a 1 ppm change in gas concentration (0.33 mV). This confirms that the noise level is negligible compared to the resolution of the sensor.

steps per ppm = 4096/9990 = 0.41 step/ppm

volts per step = volts per ppm/ steps per ppm = 0.00033/0.41 = 0.0008 V/step 

The RC filtering shows that the noise being reduced to 110 uV. This would be negligible due to the volts per step being 0.8mV or 800uV. Because it is less than 1 ppm it would not matter. 
## Bill of Materials
